...
public class day133_kruskalsalgorithm {
    int V, E;
    Edge edge[];

    day133_kruskalsalgorithm(int v, int e) {
        V = v;
        E = e;
        edge = new Edge[E];
        for (int i = 0; i < e; i++)
    ...
    public static void main(String[] args) {
        int V = 4;
        int E = 5;
        day133_kruskalsalgorithm graph = new day133_kruskalsalgorithm(V, E);
