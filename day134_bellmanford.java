// day134_bellmanford.java
import java.util.*;

public class day134_bellmanford {
    class Edge {
        int src, dest, weight;
    ...
    day134_bellmanford(int v, int e) {
        V = v;
        E = e;
        edge = new Edge[e];
        for (int i = 0; i < e; ++i)
    ...
    void BellmanFord(day134_bellmanford graph, int src) {
    ...
    public static void main(String[] args) {
        int V = 5, E = 8;
        day134_bellmanford graph = new day134_bellmanford(V, E);
